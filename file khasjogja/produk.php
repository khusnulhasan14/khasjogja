...
// memasukkan acuan paging di fungsi tampil_produk
 $pro=$produk->tampil_produk($posisi,$batas);
 ?>
 	...
 	<div class="container">
 		<div class="row">
 			<div class="col-md-10">
				...
				$totaldata = count($produk->tampil_produk());
				...
				<nav>
					<ul class="pagination">
						...
						for($i=1; $i<=$banyakpage; $i++)
						{
							...
							echo "<li class='$aktif'><a href='index.php?halaman=produk&page=$i'>$i</a></li>";
						}
						?>
					</ul>
				</nav>
